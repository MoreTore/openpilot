...
class LatControlTorqueAngle(LatControlAngle):
  ...
  def update(self, active, CS, VM, params, steer_limited, desired_curvature, llk, model_data=None, frogpilot_toggles=None):
    ...
    if not active:
      ...
      _, angle_steers_des, _ = super().update(active, CS, VM, params, steer_limited, desired_curvature, llk, model_data, frogpilot_toggles)
